...
>>>>>>> 97ad67eec23071b39a1754f7b219ba4155cf59ee
...
boost2 <- gbm(curr.formula, data = train, distribution = "gaussian",
              n.trees = num.t, interaction.depth = 6, shrinkage = 0.001, n.minobsinnode = 7)

<<<<<<< HEAD
boost2.full <- gbm(curr.formula, data = train, distribution = "gaussian", n.trees = num.t, interaction.depth = 6, shrinkage=0.001, n.minobsinnode = 13)
=======
...
boost2.preds <- predict(boost2, newdata = validate, n.trees = num.t)
boost1.preds <- predict(boost2.full, newdata = validate, n.trees = num.t)
sqrt(mean((validate$Outcome - (.5*(boost1.preds+boost2.preds)))^2))
sqrt(mean((validate$Outcome - boost2.preds)^2))
...
ID = seq(1,110)
Outcome = predict(output.model, newdata = test, n.trees = num.t, interaction.depth = 6, shrinkage = 0.001, n.minobsinnode = 7)
